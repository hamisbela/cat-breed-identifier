  ...
  return (
    <div className="bg-gradient-to-r from-emerald-100 to-teal-100 rounded-2xl p-8 text-center">
      <div className="max-w-2xl mx-auto">
        <Cat className="w-12 h-12 text-emerald-600 mx-auto mb-4" />
        <h2 className="text-3xl font-bold text-emerald-600 mb-4">Support Our Work ❤️</h2>
        <p className="text-gray-700 mb-6">
          Help us maintain and improve our free cat breed identifier by supporting us.
          Your contribution helps keep this educational tool free for all cat lovers! 🐱
        </p>
        <a
